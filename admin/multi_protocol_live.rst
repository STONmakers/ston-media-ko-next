...
LIVE서비스는 메모리만을 이용해 동작한다.
따라서 동시에서 서비스 가능한 가상호스트의 수는 물리적인 메모리 크기에 수렴한다.

.. warning::

   VOD와 LIVE 동적으로 변경할 수 없다. 
...
.. _multi-protocol-live-adobe-rtmp-session:
...
.. _multi-protocol-live-http-ps-session:
...
.. _multi-protocol-live-http-ps-connection:
...
.. _multi-protocol-live-http-ps-upfrontmp4header:
...
.. _multi-protocol-live-http-ps-throttling:
...
.. _multi-protocol-live-http-ps-modifyheader:
...
.. _multi-protocol-live-http-ps-acceptencoding:
...
.. _multi-protocol-live-http-ps-serverheader:
...
.. _multi-protocol-live-http-ps-originalheader:
